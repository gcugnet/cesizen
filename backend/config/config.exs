...
config :cesizen, CesizenWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: CesizenWeb.ErrorHTML, json: CesizenWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Cesizen.PubSub,
  live_view: [signing_salt: "A+tRLxXm"]
...
config :cesizen, Cesizen.Mailer, adapter: Swoosh.Adapters.Local
